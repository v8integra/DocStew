// turndown-plugin-gfm ships no type declarations of its own (and none exist
// on @types either) — this is the minimal real shape needed for the one
// export this module uses.
